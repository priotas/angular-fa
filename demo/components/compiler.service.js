 ...
 * @returns {!Object} Compile data with link function.
 */
    MdCompilerService.prototype._compileElement = function(
        locals,
        element,
        options
    ) {
        ...
        function linkFn(scope) {
            ...
            if (options.controller) {
                ...
                var ctrl = self._createController(
                    options,
                    injectLocals,
                    locals
                );
 ...
 */
    MdCompilerService.prototype._createController = function(
        options,
        injectLocals,
        locals
    ) {
        var invokeCtrl = this.$controller(
            options.controller,
            injectLocals,
            true,
...
export default MdCompilerProvider;
